package tutorial62_UsingIterators;
...
public class App {
	...
	public static void main(String[] args) {
		...
		/*
		 * If you want to add items to a list while iterating through it, get a
		 * ListIterator using the .listIterator() method. ListIterator also has a
		 * previous() method, allowing you to "rewind" the iterator so that you can add
		 * items before the current item.
		 */
